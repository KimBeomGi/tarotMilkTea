"""
Django settings for dataGemini project.
...
SECRET_KEY = 'django-insecure-em-0$s4&qbqh#w^*4ff)c8)iai(&$^7rt+$_pas5ptk#(*-%hz'
...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware',# 얘도 위로 올려야하나?
...
WSGI_APPLICATION = 'dataGemini.wsgi.application'
